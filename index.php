   <?php include 'header.php' ?>
            ...
            <div id="slider1" class="slider-pro">
               <div class="sp-slides">
                  <div class="sp-slide slide1-bg">
                     <div class="sp-layer" data-position="centerRight" data-vertical="0" data-horizontal="8%" data-show-delay="1500" data-show-transition="left" data-hide-transition="right" data-width="32%"><img src="img/slider/slide1.png" alt=""></div>
                  ...
                  <!-- .sp-slide --> 
                  <div class="sp-slide slide1-bg">
                     <div class="sp-layer" data-position="centerLeft" data-vertical="0" data-horizontal="8%" data-show-delay="500" data-show-transition="left" data-width="32%"><img src="img/slider/slide2.png" alt=""></div>
                  ...
                  <!-- .sp-slide --> 
                  <div class="sp-slide slide1-bg">
                     <div class="sp-layer fade" data-position="centerRight" data-vertical="0" data-horizontal="8%" data-show-delay="500" data-show-transition="left" data-hide-transition="rigth" data-width="32%"><img src="img/slider/slide3.png" alt=""></div>
         ...
         <div class="service-policy ">
            <div class="row">
               <div class="col-md-4 col-sm-4">
                  <div class="service  text-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".25s">
                     <div class="service-line service-line-right"></div>
               ...
               <!-- col-md-4  -->
               <div class="col-md-4 col-sm-4">
                  <div class="service  text-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".45s">
                     <div class="service-line service-line-left"></div>
                     <div class="service-line service-line-right"></div>
                     <div class="icon-circle-wrap img-circle">
                        <i class="fa fa-database"></i>
                     </div>
               ...
               <!-- col-md-4  -->
               <div class="col-md-4 col-sm-4">
                  <div class="service  text-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="
                  .7s">
                     <div class="service-line service-line-left"></div>
                     <div class="icon-circle-wrap img-circle">
      ...
      <!-- Section start -->
      <section class="secondary-bg padding-large-top"> <!-- offer-area -->        
         <div class="row" data-equal=".eq-height">
            <div class="col-md-6 imgLiquid text-center eq-height wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".25s" data-imgLiquid-fill="false">
               <div class="offer-image-holder">
                  <img src="img/offer-image.png" alt="image">
               </div>
            </div>
            <!-- col-md-5 -->
            <div class="col-md-6 offer-description eq-height wow fadeInRight" data-wow-duration="0.5s" data-wow-delay=".25s">
               ...
               <div class="col-md-6 offer-items1">
                  ...
                  <div class="single-offer-item">
                     ...
                     <p>Unlike traditio method you can see in real time what is or is not working for your  business online and you can adapt very quickly to improve your results.</p>
                  </div>
               </div>
               <div class="col-md-6 offer-items2">
                  <div class="single-offer-item">
                     <h3><i class="fa fa-bell-o"></i> Level playing field</h3>
                     <p>Any business can compete with any competitor regardless of size with a solid digital marketing strategy.</p>
                  </div>
                  <div class="single-offer-item">
      ...
      <!-- Section start -->
      <section class="padding-large-top padding-medium-bottom">
         <!-- Featured-Area-->
               ...
               <div class="featured-list">
                  <div class="row">
                     <div class="col-md-4 col-sm-4 text-right">
                        <div class="featured-activities wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".25s">
                           <ul>
                              <li>
                                 <div class="service featured">
                                    <!-- featured -->
                                    <div class="icon-circle-wrap img-circle pull-right">
                                       <i class="fa fa-database"></i>
                                    </div>
                                    <h3>Competitive</h3>
                                    <p>Having the Right  SEO SEO Intelligence and Competitive Data</p>
                                 </div>
                                 <!-- .service -->                 
                              </li>
                              <li>
                                 <div class="service featured">
                                    ...
                                    <p>Provides the customer with multiple choices and option.</p>
                                 </div>
                                 <!-- .service -->                 
                              </li>
                              <li>
                                 <div class="service featured">
                                    ...
                                    <p>Only our Experienced off Experts will touch your Website</p>
                                 </div>
                                 <!-- .service -->                 
                              </li>
                           </ul>
                     ...
                     <!-- col-md-4 -->
                     <div class="col-md-4 col-sm-4 text-center featured-image wow fadeIn" data-wow-duration="0.5s" data-wow-delay=".25s">
                        <img src="img/featured-image-1.png" alt="image">
                     </div>
                     <!-- col-md-4 -->
                     <div class="col-md-4 col-sm-4 text-left wow fadeInRight" data-wow-duration="0.5s" data-wow-delay=".25s">
                        <div class="featured-activities featured-activities-right">
                           <ul>
                              <li>
                                 <div class="service featured">
                                    <!-- featured -->
                                    ...
                                    <h3>Assignment</h3>
                                    <p>Reduce Communication and issues and directly assign </p>
                                 </div>
                                 <!-- .service -->                 
                              </li>
                              <li>
                                 <div class="service featured">
                                    ...
                                    <h3>Optimization</h3>
                                    <p>Social Media Optimization promotes your brand identity</p>
                                 </div>
                                 <!-- .service -->                 
                              </li>
                              <li>
                                 <div class="service featured">
                                    ...
                                    <h3>User Freindly</h3>
                                    <p>It creates a Search engine friendly website for the user</p>
                                 </div>
                                 <!-- .service -->                 
                              </li>
                           </ul>
               ...
               <div class="col-md-7">
                  <form>
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <label>I would like to discuss with</label>
                           <select>
                              <option value="1">Content Marketing</option>
         ...
         <div class="container">
            <div class="row text-center">
               <div class="col-md-3 col-sm-3 col-sx-6">
                  <div class="progress-work border-right wow zoomIn" data-wow-duration="0.5s" data-wow-delay=".25s">
               ...
               <div class="col-md-3 col-sm-3 col-sx-6">
                  <div class="progress-work border-right  wow zoomIn" data-wow-duration="0.5s" data-wow-delay=".45s">
                     <span class="progress-work-icon">
               ...
               <div class="col-md-3 col-sm-3 col-sx-6">
                  <div class="progress-work border-right  wow zoomIn" data-wow-duration=".7s" data-wow-delay=".7s">
                     <span class="progress-work-icon">
               ...
               <div class="col-md-3 col-sm-3 col-sx-6">
                  <div class="progress-work  wow zoomIn" data-wow-duration="0.5s" data-wow-delay=".7s">
                     <span class="progress-work-icon">
         ...
         <div class="row display-table">
            <div class="col-md-6 col-sm-6 verticla-align-middle wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".25s">
               <div class="working-formula-image-holder">
                  <img src="img/working-formula-image.png" alt="image">
               </div>
            </div>
            <!-- col-md-6 close-->
